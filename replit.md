...
- **Contacts Service**: `app/services/contacts.py` centralises contact upserts, label management, and interaction tracking when the agent sends or receives email.
